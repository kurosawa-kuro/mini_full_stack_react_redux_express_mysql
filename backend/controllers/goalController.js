...
// @route   GET /api/goals
// @access  Private
const getGoalsWithoutUser = asyncHandler(async (req, res) => {
    const resData = await Goal.findAll();
    console.log({ resData })
...
// @route   POST /api/goals
// @access  Private
const setGoalWithoutUser = asyncHandler(async (req, res) => {
    const inputData = {
        text: req.body.text
    }
...
// @route   PUT /api/goals/:id
// @access  Private
const updateGoalWithoutUser = asyncHandler(async (req, res) => {
    const id = req.params.id;
    const inputData = {
        text: req.body.text
    }
...
// @route   DELETE /api/goals/:id
// @access  Private
const deleteGoalWithoutUser = asyncHandler(async (req, res) => {
    const id = req.params.id;
    const goal = await Goal.findByPk(id);
